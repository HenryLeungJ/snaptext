...
export default function Header() {
    return(
        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="https://henryleungj.vercel.app" className="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="/mail.svg" className="h-8 drop-shadow-lg" alt="Flowbite Logo" />
                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white drop-shadow-lg">SnapText</span>
            </a>
